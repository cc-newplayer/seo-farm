...
const toolsData = [
  // ── 热门工具 TOP 20（renderHotTools slice(0,20)展示）──
  ...
  // ── 新增工具（id 49-86）──
  { id: 49, name: '文心一言', icon: '🔶', logo: 'https://www.google.com/s2/favicons?domain=ernie.baidu.com&sz=32', category: 'chat', color: '#2563eb', desc: '百度出品，国内访问流畅，支持联网搜索与图片生成。', badge: 'freemium', stars: 4, url: 'https://ernie.baidu.com', matchKeys: [] },
  { id: 50, name: 'BigModel', icon: '🧠', logo: 'https://www.google.com/s2/favicons?domain=bigmodel.cn&sz=32', category: 'chat', color: '#6d28d9', desc: '智谱AI出品，GLM-5.1接口，代码能力超越GPT-5.4。', badge: 'freemium', stars: 4, url: 'https://bigmodel.cn', matchKeys: [] },
  { id: 51, name: 'Mistral AI', icon: '⚡', logo: 'https://www.google.com/s2/favicons?domain=mistral.ai&sz=32', category: 'chat', color: '#f59e0b', desc: '欧洲最强开源大模型，轻量高效，支持本地部署。', badge: 'freemium', stars: 4, url: 'https://mistral.ai', matchKeys: [] },
  { id: 52, name: 'Meta AI', icon: '🦙', logo: 'https://www.google.com/s2/favicons?domain=meta.ai&sz=32', category: 'chat', color: '#0866ff', desc: 'Meta出品基于Llama，全平台免费内嵌WhatsApp/Instagram。', badge: 'free', stars: 4, url: 'https://meta.ai', matchKeys: [] },
  { id: 53, name: 'Groq', icon: '🚀', logo: 'https://www.google.com/s2/favicons?domain=groq.com&sz=32', category: 'chat', color: '#f97316', desc: '免费推理API，速度全球最快，Llama/Mixtral即开即用。', badge: 'free', stars: 5, url: 'https://groq.com', matchKeys: [] },
  { id: 54, name: 'Poe', icon: '🎯', logo: 'https://www.google.com/s2/favicons?domain=poe.com&sz=32', category: 'chat', color: '#8b5cf6', desc: 'Quora出品，一站式访问ChatGPT/Claude/Gemini等主流模型。', badge: 'freemium', stars: 4, url: 'https://poe.com', matchKeys: [] },
  { id: 55, name: 'Replit AI', icon: '🔁', logo: 'https://www.google.com/s2/favicons?domain=replit.com&sz=32', category: 'code', color: '#f97316', desc: '浏览器内云端IDE，AI一键生成并运行应用，无需配环境。', badge: 'freemium', stars: 4, url: 'https://replit.com', matchKeys: [] },
  { id: 56, name: 'Amazon Q', icon: '☁️', logo: 'https://www.google.com/s2/favicons?domain=aws.amazon.com&sz=32', category: 'code', color: '#ff9900', desc: 'AWS官方AI编程助手，深度集成IDE与云服务。', badge: 'freemium', stars: 4, url: 'https://aws.amazon.com', matchKeys: [] },
  { id: 57, name: 'Tabnine', icon: '📋', logo: 'https://www.google.com/s2/favicons?domain=tabnine.com&sz=32', category: 'code', color: '#1d4ed8', desc: '企业级AI代码补全，私有部署数据不出境。', badge: 'freemium', stars: 4, url: 'https://tabnine.com', matchKeys: [] },
  { id: 58, name: 'Continue.dev', icon: '🔌', logo: 'https://www.google.com/s2/favicons?domain=continue.dev&sz=32', category: 'code', color: '#10b981', desc: '开源AI IDE插件，自由接入任意模型，完全免费。', badge: 'free', stars: 4, url: 'https://continue.dev', matchKeys: [] },
  { id: 59, name: 'Lovable', icon: '💜', logo: 'https://www.google.com/s2/favicons?domain=lovable.dev&sz=32', category: 'code', color: '#a855f7', desc: '对话式全栈应用生成器，一句话出React应用并部署。', badge: 'freemium', stars: 4, url: 'https://lovable.dev', matchKeys: [] },
  { id: 60, name: 'Gemini CLI', icon: '💎', logo: 'https://www.google.com/s2/favicons?domain=github.com&sz=32', category: 'code', color: '#4285f4', desc: '谷歌开源终端AI，每日1000次免费，平替Claude Code。', badge: 'free', stars: 5, url: 'https://github.com', matchKeys: [] },
  { id: 61, name: 'Ideogram', icon: '✍️', logo: 'https://www.google.com/s2/favicons?domain=ideogram.ai&sz=32', category: 'image', color: '#06b6d4', desc: '文字渲染最准确的AI图像生成，每天免费25张。', badge: 'freemium', stars: 5, url: 'https://ideogram.ai', matchKeys: [] },
  { id: 62, name: 'Canva AI', icon: '🎨', logo: 'https://www.google.com/s2/favicons?domain=canva.com&sz=32', category: 'image', color: '#00c4cc', desc: '设计平台内置AI，生成图像直接用于设计，免费可用。', badge: 'freemium', stars: 5, url: 'https://canva.com', matchKeys: [] },
  { id: 63, name: 'Microsoft Designer', icon: '🖼', logo: 'https://www.google.com/s2/favicons?domain=designer.microsoft.com&sz=32', category: 'image', color: '#0078d4', desc: '微软出品，免费文生图，深度整合M365。', badge: 'free', stars: 4, url: 'https://designer.microsoft.com', matchKeys: [] },
  { id: 64, name: 'Photoroom', icon: '📸', logo: 'https://www.google.com/s2/favicons?domain=photoroom.com&sz=32', category: 'image', color: '#374151', desc: 'AI商品图处理，一键抠图换背景，电商必备。', badge: 'freemium', stars: 4, url: 'https://photoroom.com', matchKeys: [] },
  { id: 65, name: 'Recraft', icon: '🎭', logo: 'https://www.google.com/s2/favicons?domain=recraft.ai&sz=32', category: 'image', color: '#7c3aed', desc: '设计师向AI图像工具，支持矢量图与品牌一致性。', badge: 'freemium', stars: 4, url: 'https://recraft.ai', matchKeys: [] },
  { id: 66, name: 'Magnific', icon: '🔍', logo: 'https://www.google.com/s2/favicons?domain=magnific.ai&sz=32', category: 'image', color: '#f59e0b', desc: 'AI图像超分放大，细节还原能力业界最佳。', badge: 'paid', stars: 4, url: 'https://magnific.ai', matchKeys: [] },
  { id: 67, name: 'Invideo AI', icon: '🎬', logo: 'https://www.google.com/s2/favicons?domain=invideo.io&sz=32', category: 'video', color: '#7c3aed', desc: '文字脚本自动生成完整视频，内容创作者首选。', badge: 'freemium', stars: 4, url: 'https://invideo.io', matchKeys: [] },
  { id: 68, name: 'Synthesia', icon: '🎤', logo: 'https://www.google.com/s2/favicons?domain=synthesia.io&sz=32', category: 'video', color: '#10b981', desc: 'AI数字人讲解视频，支持140+语言，企业培训首选。', badge: 'paid', stars: 4, url: 'https://synthesia.io', matchKeys: [] },
  { id: 69, name: 'D-ID', icon: '🧑', logo: 'https://www.google.com/s2/favicons?domain=d-id.com&sz=32', category: 'video', color: '#6366f1', desc: '照片���说话头像，支持实时对话数字人。', badge: 'freemium', stars: 4, url: 'https://d-id.com', matchKeys: [] },
  { id: 70, name: 'Veed.io', icon: '✂️', logo: 'https://www.google.com/s2/favicons?domain=veed.io&sz=32', category: 'video', color: '#f97316', desc: '在线AI视频编辑，自动字幕翻译，无需下载软件。', badge: 'freemium', stars: 4, url: 'https://veed.io', matchKeys: [] },
  { id: 71, name: 'Topaz Video AI', icon: '🔬', logo: 'https://www.google.com/s2/favicons?domain=topazlabs.com&sz=32', category: 'video', color: '#374151', desc: '老视频AI修复与超分，4K补帧效果最佳。', badge: 'paid', stars: 4, url: 'https://topazlabs.com', matchKeys: [] },
  { id: 72, name: 'Descript', icon: '🎙', logo: 'https://www.google.com/s2/favicons?domain=descript.com&sz=32', category: 'audio', color: '#f97316', desc: '像编辑文档一样剪视频，AI去噪、删词自动剪片。', badge: 'freemium', stars: 5, url: 'https://descript.com', matchKeys: [] },
  { id: 73, name: 'Adobe Podcast', icon: '🎚', logo: 'https://www.google.com/s2/favicons?domain=podcast.adobe.com&sz=32', category: 'audio', color: '#f97316', desc: '免费AI音质增强，消除噪音堪比专业录音棚。', badge: 'free', stars: 5, url: 'https://podcast.adobe.com', matchKeys: [] },
  { id: 74, name: 'Speechify', icon: '📖', logo: 'https://www.google.com/s2/favicons?domain=speechify.com&sz=32', category: 'audio', color: '#3b82f6', desc: '文字转真人语音，支持中文，阅读障碍者利器。', badge: 'freemium', stars: 4, url: 'https://speechify.com', matchKeys: [] },
  { id: 75, name: 'Play.ht', icon: '🎵', logo: 'https://www.google.com/s2/favicons?domain=play.ht&sz=32', category: 'audio', color: '#8b5cf6', desc: 'AI声音克隆平台，900+真实语音，API可商用。', badge: 'freemium', stars: 4, url: 'https://play.ht', matchKeys: [] },
  { id: 76, name: 'Zapier AI', icon: '⚡', logo: 'https://www.google.com/s2/favicons?domain=zapier.com&sz=32', category: 'productivity', color: '#ff4a00', desc: '7000+应用自动化连接，内置AI步骤无需代码。', badge: 'freemium', stars: 5, url: 'https://zapier.com', matchKeys: [] },
  { id: 77, name: 'Google AI Studio', icon: '🔬', logo: 'https://www.google.com/s2/favicons?domain=aistudio.google.com&sz=32', category: 'productivity', color: '#4285f4', desc: '免费Gemini API调试平台，200万token上下文。', badge: 'free', stars: 5, url: 'https://aistudio.google.com', matchKeys: [] },
  { id: 78, name: 'Jasper AI', icon: '✍️', logo: 'https://www.google.com/s2/favicons?domain=jasper.ai&sz=32', category: 'productivity', color: '#6d28d9', desc: '营销内容AI写作平台，品牌声音一致性最强。', badge: 'paid', stars: 4, url: 'https://jasper.ai', matchKeys: [] },
  { id: 79, name: 'Copy.ai', icon: '📝', logo: 'https://www.google.com/s2/favicons?domain=copy.ai&sz=32', category: 'productivity', color: '#10b981', desc: 'AI文案生成，覆盖社媒/邮件/广告，有免费套餐。', badge: 'freemium', stars: 4, url: 'https://copy.ai', matchKeys: [] },
  { id: 80, name: 'Tome', icon: '📊', logo: 'https://www.google.com/s2/favicons?domain=tome.app&sz=32', category: 'productivity', color: '#8b5cf6', desc: 'AI演示文稿生成，一句话输出完整汇报。', badge: 'freemium', stars: 4, url: 'https://tome.app', matchKeys: [] },
  { id: 81, name: 'Otter.ai', icon: '🦦', logo: 'https://www.google.com/s2/favicons?domain=otter.ai&sz=32', category: 'productivity', color: '#0ea5e9', desc: 'AI会议转录，实时字幕，自动生成会议摘要。', badge: 'freemium', stars: 5, url: 'https://otter.ai', matchKeys: [] },
  { id: 82, name: 'Taskade', icon: '✅', logo: 'https://www.google.com/s2/favicons?domain=taskade.com&sz=32', category: 'productivity', color: '#7c3aed', desc: 'AI任务管理+多Agent工作流，团队协作一体化。', badge: 'freemium', stars: 4, url: 'https://taskade.com', matchKeys: [] },
  { id: 83, name: 'CrewAI', icon: '🤝', logo: 'https://www.google.com/s2/favicons?domain=crewai.com&sz=32', category: 'productivity', color: '#e11d48', desc: '开源多智能体框架，定义角色分工自动完成复杂任务。', badge: 'free', stars: 4, url: 'https://crewai.com', matchKeys: [] },
  { id: 84, name: 'Flowise', icon: '🌊', logo: 'https://www.google.com/s2/favicons?domain=flowiseai.com&sz=32', category: 'productivity', color: '#0ea5e9', desc: '零代码拖拽构建LLM应用，支持自托管完全免费。', badge: 'free', stars: 5, url: 'https://flowiseai.com', matchKeys: [] },
  { id: 85, name: 'Replicate', icon: '🔁', logo: 'https://www.google.com/s2/favicons?domain=replicate.com&sz=32', category: 'productivity', color: '#374151', desc: '一行代码调用数千开源AI模型，按用量计费。', badge: 'freemium', stars: 4, url: 'https://replicate.com', matchKeys: [] },
  { id: 86, name: 'Hugging Face', icon: '🤗', logo: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=32', category: 'productivity', color: '#f59e0b', desc: '全球最大AI模型社区，Spaces免费部署演示应用。', badge: 'freemium', stars: 5, url: 'https://huggingface.co', matchKeys: [] },
];
...
function renderHotTools() {
  ...
  if (!list) return;
  const hot = toolsData.slice(0, 20);
...
const glossaryData = [
  { term: 'Token',                   oneliner: 'AI的最小处理单位，也是计费依据；大约1个中文字≈1.5 Token',               keywords: 'token 计费 单位 上下文 费用' },
  { term: 'Context Window（上下文窗口）', oneliner: 'AI一次能"看到"的最大文本量，决定它能记住多少对话内容',              keywords: 'context window 上下文 记忆 长度 限制' },
  { term: 'Prompt（提示词）',            oneliner: '你发给AI的指令或问题；写得越清晰，输出质量越高',                     keywords: 'prompt 提示词 指令 输入' },
  { term: '幻觉（Hallucination）',       oneliner: 'AI一本正经地编造不存在内容的现象，是大模型最主要的缺陷之一',           keywords: '幻觉 hallucination 编造 错误 一本正经' },
  { term: 'Temperature（温度）',         oneliner: '控制AI回复随机程度的参数：低温保守严谨，高温发散创意',               keywords: 'temperature 温度 随机性 创意 保守' },
  { term: '微调（Fine-tuning）',          oneliner: '在已有大模型基础上，用专属数据再训练，让它精通特定领域',              keywords: '微调 fine-tuning 训练 定制 专业' },
  { term: '参数（Parameters）',           oneliner: '模型的"记忆量"，70B = 700亿参数；越大能力越强，但也越吃算力',        keywords: '参数 parameters 70b 7b 规模' },
  { term: '量化（Quantization）',         oneliner: '压缩模型体积的技术，让大模型能在消费级设备上本地运行',               keywords: '量化 quantization int4 int8 压缩 本地' },
  { term: 'MoE（混合专家架构）',           oneliner: '每次推理只激活部分参数，大幅降低计算成本',                         keywords: 'moe mixture of experts 混合专家 激活 deepseek' },
  { term: 'Transformer',               oneliner: '几乎所有主流大模型的底层架构，2017年谷歌提出',                        keywords: 'transformer 注意力机制 attention 架构' },
  { term: 'RLHF（人类反馈强化学习）',      oneliner: '让模型学会"人类偏好"的训练方法，是ChatGPT变好用的关键技术',         keywords: 'rlhf 强化学习 人类反馈 对齐 偏好' },
  { term: 'LLM（大语言模型）',            oneliner: '在海量文本上训练的超大规模语言模型，GPT、Claude、Gemini都属于LLM',  keywords: 'llm 大语言模型 large language model' },
  { term: '多模态（Multimodal）',          oneliner: '能同时处理文字、图片、音频、视频等多种信息形式的AI模型',             keywords: '多模态 multimodal 图片 音频 视频 视觉' },
  { term: '蒸馏（Knowledge Distillation）', oneliner: '用大模型的输出训练小模型，让小模型继承大模型的能力',              keywords: '蒸馏 distillation 知识蒸馏 小模型' },
  { term: 'Zero-shot / Few-shot',       oneliner: 'Zero-shot直接问不给例子；Few-shot给几个示例再问，后者通常更准',       keywords: 'zero-shot few-shot 零样本 少样本 示例' },
  { term: 'AI Agent（智能体）',           oneliner: '能自主规划、调用工具、完成多步任务的AI系统，不只聊天，而是干活',     keywords: 'ai agent 智能体 自主 任务 规划 工具' },
  { term: 'MCP（模型上下文协议）',         oneliner: 'Anthropic提出的AI连接外部工具的标准协议，六个月装机9700万次',       keywords: 'mcp model context protocol 协议 工具 标准' },
  { term: 'RAG（检索增强生成）',           oneliner: '让AI先查资料再回答，大幅减少幻觉，也能接入你的私有知识库',         keywords: 'rag 检索增强 知识库 幻觉 文档 向量' },
  { term: 'Tool Use / Function Calling', oneliner: 'AI调用外部函数或API的能力，让模型从"说"变成"做"',                  keywords: 'tool use function calling 工具调用 函数 api' },
  { term: 'ReAct',                      oneliner: 'AI Agent的核心推理框架：交替思考→行动→观察结果，循环直到完成任务',   keywords: 'react 推理 行动 思考 框架 agent' },
  { term: 'Multi-Agent（多智能体）',       oneliner: '多个AI Agent分工协作完成任务，类似"AI团队"',                      keywords: 'multi-agent 多智能体 协作 mas 分工' },
  { term: 'Prompt注入',                  oneliner: '通过恶意输入操控AI执行非预期指令的攻击方式',                        keywords: 'prompt注入 prompt injection 攻击 安全 漏洞' },
  { term: 'Human-in-the-Loop',          oneliner: '在AI工作流关键节点加入人工确认环节，控制风险',                      keywords: 'human in the loop 人工确认 审核 风险' },
  { term: '沙箱（Sandbox）',              oneliner: '让AI在隔离环境中执行代码，出了问题不影响真实系统',                   keywords: '沙箱 sandbox 隔离 安全 执行环境' },
  { term: '向量数据库',                   oneliner: '专门存储和检索Embedding向量的数据库，是RAG系统的核心存储层',        keywords: '向量数据库 vector database pinecone chroma rag' },
  { term: 'GPU',                         oneliner: 'AI训练和推理的核心算力硬件，英伟达H100/H200是最主流的AI训练芯片',    keywords: 'gpu 显卡 算力 nvidia 英伟达 训练 推理' },
  { term: 'API',                         oneliner: '程序调用AI模型能力的接口，有了API Key就能用代码接入GPT、Claude',     keywords: 'api 接口 调用 key 开发 代码' },
  { term: 'KV Cache',                    oneliner: '大模型推理时缓存中间计算结果的机制，让长对话不需要每次重算',          keywords: 'kv cache 缓存 推理 内存 速度 优化' },
  { term: 'Ollama',                      oneliner: '3条命令在本地跑DeepSeek/Llama，数据不出机，完全免费',               keywords: 'ollama 本地 部署 llama deepseek 免费 离线' },
  { term: 'LangChain / LangGraph',       oneliner: '构建AI应用和Agent工作流的主流Python框架',                          keywords: 'langchain langgraph 框架 agent 工作流 开发' },
  { term: 'Embedding（向量嵌入）',         oneliner: '把文字转成一串数字，让计算机能计算文本之间的语义相似度',            keywords: 'embedding 向量 嵌入 语义 搜索 rag' },
  { term: 'Benchmark（基准测试）',         oneliner: '评测AI模型能力的标准化测试集，用于横向比较不同模型的水平',          keywords: 'benchmark 基准测试 评测 排行 能力' },
  { term: 'SWE-bench',                   oneliner: '评测AI代码能力的权威基准：给模型真实GitHub Issue，看它能否修复',     keywords: 'swe-bench 代码 编程 软件工程 测评' },
  { term: '开源 vs 闭源',                  oneliner: '模型权重是否公开：开源可本地部署，闭源只能通过API访问',             keywords: '开源 闭源 权重 商用 许可证' },
  { term: 'Apache 2.0',                  oneliner: '最常见的开源许可证之一，允许免费商用，AI开源模型最喜欢用这个',       keywords: 'apache 2.0 许可证 商用 免费 协议' },
  { term: '具身智能（Embodied AI）',        oneliner: '能感知物理世界并与之交互的AI，简单说就是给机器人装上能思考的大脑', keywords: '具身智能 embodied ai 机器人 物理 感知' },
  { term: '推理模型（Reasoning Model）',    oneliner: '回答前先"想一想"的模型，通过延长思考过程大幅提升复杂问题准确率',  keywords: '推理模型 reasoning model 思维链 chain of thought 深度思考' },
  { term: '对齐（Alignment）',             oneliner: '让AI行为符合人类价值观和意图的研究方向，是AI安全领域的核心课题',   keywords: '对齐 alignment 安全 价值观 有害' },
  { term: 'AGI（通用人工智能）',            oneliner: '能在所有认知任务上达到或超越人类水平的AI，目前尚未实现',          keywords: 'agi 通用人工智能 general artificial intelligence 超级 强ai' },
  { term: 'Scaling Law（规模定律）',        oneliner: '模型越大、数据越多、算力越多，性能就越好——这个规律驱动了AI的爆炸式进步', keywords: 'scaling law 规模定律 更大 更多 算力 数据' },
...
function doSearch() {
  ...
  const glossary = glossaryData.filter(g =>
  ...
  if (glossary.length) {
    html += `<div class="sr-section"><div class="sr-label">📖 术语</div>`;
    html += glossary.map(g => `
      <a class="sr-item" href="glossary.html">
        <div class="sr-icon" style="background:rgba(96,165,250,0.12)">📖</div>
        <div class="sr-body">
          <div class="sr-title">${g.term}</div>
          <div class="sr-sub">${g.oneliner}</div>
        </div>
        <span class="sr-tag sr-tag-glossary">术语表</span>
      </a>`).join('');
    html += `</div>`;
  }
